...
// Copyright (c) 2013 Chococoin developers
...
const string strMessageMagic = "Chococoin Signed Message:\n";
...
static const int64 nTargetTimespan = 6000; 
...
static const int64 nMaxAdjustDown = 10; // 5% adjustment down
static const int64 nMaxAdjustUp = 10; // 5% adjustment up
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ChococoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ChococoinMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running ChococoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("ChococoinMiner terminated\n");
        throw;
    }
}
